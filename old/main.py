...
def choice(actionable, state, player_id):
    ...
    for action in actionable:
        ...
        for next_action in next_actionable:
            ...
            # --- [t+2] ---
            next_next_state, next_next_player_id, next_opponent_reverse_places = get_next_state(next_state, next_action, next_player_id)
...
# テスト
state = ['........', '....0...', '.0001...', '101000..', '11111...', '11.110..', '1.1.....', '........']
actionable = ['d2', 'f3', 'g3', 'g7', 'b2', 'c2', 'f1', 'g4', 'a2', 'e1', 'g5', 'a3', 'g6']
player_id = "1"
...
# state = ['......1.', '.....1..', '111110..', '01000000', '000001..', '0001.0..', '........', '........']
# action = "a7"
# next_state, next_player_id, change_places_all = get_next_state(state, action, "1")
# # print("next_state: ", next_state)
# # print("chage_places_all: ", change_places_all)

# next_next_state, next_next_player_id, next_opponent_reverse_places = get_next_state(next_state, "f1", "0")
# print("next_next_state: ", next_next_state)
# print("next_opponent_reverse_places: ", next_opponent_reverse_places)
